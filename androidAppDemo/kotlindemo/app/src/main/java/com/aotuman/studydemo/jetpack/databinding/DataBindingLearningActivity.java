...
import com.aotuman.studydemo.databinding.ActivityDataBindingLearningBinding;
import com.aotuman.studydemo.jetpack.databinding.bean.User;
...
//
        ...
        // 这样就ok了，你会发现 我们不需要在 Activity中 拿到LivaData 去 observe(owner，observer)了，
        // DataBinding 自动生成的代码，会帮我们去做这操作，所以需要设置LifecycleOwner。
