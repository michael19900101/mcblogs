...
public class EllipseActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_ellipse2);
        ...
        tvEnd.setText("中华人民共和国中央人民政府仿小红书实现的文本展开/收起的功能");
        ((EllipsingTextView)tvEnd).setMaxLines(1);
        ...
        ((EllipsingTextView)tvEnd).setShowMoreListener(new EllipsingTextView.ShowMoreListener() {
            @Override
            public void onClick() {
                Toast.makeText(EllipseActivity2.this,"发生了点击效果",Toast.LENGTH_SHORT).show();
                ((EllipsingTextView) tvEnd).showFullText("中华人民共和国中央人民政府仿小红书实现的文本展开/收起的功能");
            }
        });
...
//                tv.setText(realText);
                ...
                sss.setSpan(new MyClickText(EllipseActivity2.this),realText.length() - endText.length() ,
                        realText.length(),
