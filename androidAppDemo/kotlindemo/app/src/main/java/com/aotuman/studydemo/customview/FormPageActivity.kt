...
class FormPageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editTextView1.setDisplayMode(FormBaseViewGroup.PLAIN)
        ...
        editTextView2.setDisplayMode(FormBaseViewGroup.PLAIN)
        ...
        editTextView3.setDisplayMode(FormBaseViewGroup.PLAIN)
        ...
        editTextView4.setDisplayMode(FormBaseViewGroup.PLAIN)
        ...
        editTextView5.setDisplayMode(FormBaseViewGroup.FREE)
        ...
        editTextView6.setDisplayMode(FormBaseViewGroup.FREE)
        ...
        editTextView7.setDisplayMode(FormBaseViewGroup.FREE)
        ...
        editTextView8.setDisplayMode(FormBaseViewGroup.FREE)
