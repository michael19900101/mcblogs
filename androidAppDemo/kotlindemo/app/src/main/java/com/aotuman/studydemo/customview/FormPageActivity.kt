...
class FormPageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editTextView1.setDispalyMode(FormBaseViewGroup.PLAIN)
        ...
        editTextView2.setDispalyMode(FormBaseViewGroup.PLAIN)
        ...
        editTextView3.setDispalyMode(FormBaseViewGroup.PLAIN)
        ...
        editTextView4.setDispalyMode(FormBaseViewGroup.PLAIN)
        ...
        editTextView5.setDispalyMode(FormBaseViewGroup.FREE)
        ...
        editTextView6.setDispalyMode(FormBaseViewGroup.FREE)
        ...
        editTextView7.setDispalyMode(FormBaseViewGroup.FREE)
        ...
        editTextView8.setDispalyMode(FormBaseViewGroup.FREE)
